...
public class ExamScores  implements java.io.Serializable {
    ...
    public ExamScores(Integer studentId, Integer examId, BigDecimal marks, Integer gradingLevelId, String remarks, Boolean isFailed, Date createdAt, Date updatedAt) {
