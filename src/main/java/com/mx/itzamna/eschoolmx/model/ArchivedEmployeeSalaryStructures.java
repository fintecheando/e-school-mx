...
/**
 * ArchivedEmployeeSalaryStructures generated by hbm2java
 */
@Entity
@Table(name="archived_employee_salary_structures"
    ,catalog="villaeducativa"
)
public class ArchivedEmployeeSalaryStructures  implements java.io.Serializable {
    ...
    public ArchivedEmployeeSalaryStructures() {
    }

    public ArchivedEmployeeSalaryStructures(Integer employeeId, Integer payrollCategoryId, String amount) {
