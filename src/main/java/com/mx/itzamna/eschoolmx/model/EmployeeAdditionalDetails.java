...
/**
 * EmployeeAdditionalDetails generated by hbm2java
 */
@Entity
@Table(name="employee_additional_details"
    ,catalog="villaeducativa"
)
public class EmployeeAdditionalDetails  implements java.io.Serializable {
    ...
    public EmployeeAdditionalDetails(Integer employeeId, Integer additionalFieldId, String additionalInfo) {
